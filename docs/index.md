...
<div class="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
  ...
  <div class="mx-auto mt-16 grid max-w-lg grid-cols-1 items-center gap-y-6 sm:mt-20 sm:gap-y-0 lg:max-w-4xl lg:grid-cols-2">
    <div class="rounded-3xl rounded-t-3xl bg-white/60 p-8 ring-1 ring-gray-900/10 sm:mx-8 sm:rounded-b-none sm:p-10 lg:mx-0 lg:rounded-bl-3xl lg:rounded-tr-none">
      <h3 id="tier-hobby" class="text-base font-semibold leading-7 text-indigo-600">Self-Hosting - Open Source</h3>
    ...
    <div
      ...
      <h3 id="tier-enterprise" class="text-base font-semibold leading-7 text-indigo-400">Hosted - Pro</h3>
      <p class="mt-4 flex items-baseline gap-x-2">
        <span class="text-5xl font-bold tracking-tight text-white">10 €</span>
