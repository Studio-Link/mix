<template>
  ...
  <button
    ...
    class="flex w-full justify-center rounded-md border border-transparent bg-green-700 py-2 px-4 text-sm font-bold text-white shadow-xs hover:bg-geen-800 focus:outline-hidden focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
    @click="preview()"
  >
    Snapshot
  </button>
  ...
  <button
    ...
    class="flex w-full justify-center rounded-md border border-transparent bg-green-700 py-2 px-4 text-sm font-bold text-white shadow-xs hover:bg-green-800 focus:outline-hidden focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
